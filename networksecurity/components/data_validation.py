...
class DatatValidaiton:
    ...
    def initiate_data_validation(self):
        try:
            ...
            ## read the data from the train and test paths 
            train_dataframe = DatatValidaiton.read_data(train_file_path)
            test_dataframe= DatatValidaiton.read_data(test_file_path)
